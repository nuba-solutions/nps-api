...
-- DropForeignKey
ALTER TABLE "_ClientProviderToUser" DROP CONSTRAINT "_ClientProviderToUser_B_fkey";

-- DropIndex
DROP INDEX "User_id_key";

-- AlterTable
ALTER TABLE "Charge" ALTER COLUMN "userId" SET DATA TYPE TEXT;
...
-- AlterTable
ALTER TABLE "_ClientProviderToUser" ALTER COLUMN "B" SET DATA TYPE TEXT;
